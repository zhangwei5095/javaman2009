...
public class LoginAction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		reqInfo.setLoginName("request-NDot");
		reqInfo.setLoginRole("requst-admin");
		req.setAttribute("reqInfo", reqInfo);

		SessionScopBean sessionInfo = (SessionScopBean) ctx
				.getBean("SessionScopBean");
		sessionInfo.setLoginName("session-NDot");
		sessionInfo.setLoginRole("session-admin");
		...
		globalSessionInfo.setLoginName("globalSession-NDot");
