...
/**
 * TODO 把报文体中剩下的内容作为一个完整域，以16进制字符串格式表示二进制数据
 *
 */
public class ISOEntireFieldPackager extends ISOFieldPackager {
	...
	public ISOEntireFieldPackager(int len, String description) {
