 ...
 * @see ISOComponent
 */
public class ISO8583ATMPPackager extends ISOBasePackager
{
  ...
  protected ISOFieldPackager fld[] = {
      ...
      /* 022 */new IFA_NUMERIC(3, "Point Of Service Entry Mode Code"),
      ...
      /* 054 */new IFA_LLLCHAR(40, "Amounts, additional"),//
      /* 055 */new IFA_LLLBINARY(255, "IC card system related data"),
      /* 056 */new IFA_LLNUM(35, "Original data elements"),
      /* 057 */new IFA_LLLCHAR(100, "Authorization life cycle code"),//
      /* 058 */new IFA_LLLCHAR(100, "IC(PBOC) Data Reserved"), //
      /* 059 */new IFA_LLLCHAR(600, "Detail Inquiring"), //
      /* 060 */new IFA_LLLCHAR(30, "Reserved"), //
      /* 061 */new IFA_LLLCHAR(200, "Cardholder Authentication Information"), //
      /* 062 */new IFA_LLLCHAR(200, "Switching Data"), //
