...
public class FieldPackagerFactory {
	 ...
	 *            填充内容0 - 0 1 - 空格
	 * @param fieldLenType
	 *            数据域类型 1-定长域 2-变长分割域 3-变长域 4-明细域 6-整体域，这个域一直到报文结束
	 * @param detailNumLen
	 *            明细域条数的位数
	 * @parametailLen 明细域长度
	 * @param detailPreLen
	 ...
	 * @Params:
	 *  
	 *  String preType: 0 - ASCII前缀 1 - BCD前缀 2 - EBDC前缀 3 - Binary前缀 4 - Null前缀 
	 *  
	 *  int preLen :   前缀位数 
	 *  
	 *  String dataType : 数据类型 0 - ASCII字符 1 - BCD码 2 - EBDC码 3 - Binary二进制 
	 *  
	 *  int dataLen : 数据长度（数据最大长度） 
	 *  
	 *  String pad : 填充方式 0 - 左补0 1 -右补空格
	 */
